...
def writecommand():
    ...
    while True:
        ...
        elif 'exit' in abc or 'disable writing mode' in abc or 'deactivate' in abc:
...
if __name__ == "__main__":
    ...
    playsound('D:\\programming\\Frost\\activating sound.mp3')
    notification.notify(title = "F_R_I_D_A_Y", message = "Welcome Back Sir!", app_icon = 'circleknot.ico', timeout = 30)
    ...
    while True :
        ...
        if 'who are you' in query:
            ...
            speak("on the way of opening excel!")
